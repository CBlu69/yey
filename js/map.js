...
export function initMap(user) {
    ...
    async function stopSharing() {
        ...
        // پاک کردن نشانگر خودمون از نقشه دوستا (از طریق حذف خودمون)
        var old = allPins.find(function (x) { return x.id === 'share-' + String(cu.id) })
    ...
    function addFriendMarker(share) {
        ...
        marker.bindPopup('<div style="text-align:center;"><b>' + (share.user_name || 'ناشناس') + '</b><br><span style="color:#2ed573;">🟢 اشتراک</span></div>')
    ...
    function addPinToMap(pin) {
        ...
        var popup = '<div style="text-align:center;"><b>📌 ' + pin.name + '</b><br><small>' + (pin.user_name || 'ناشناس') + '</small>'
